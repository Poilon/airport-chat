...
ActiveRecord::Schema[7.0].define(version: 2025_01_19_000003) do
  ...
  create_table "rooms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["airport_id"], name: "index_rooms_on_airport_id", unique: true
  end

  add_foreign_key "messages", "rooms"
  add_foreign_key "rooms", "airports"
end
